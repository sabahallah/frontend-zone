...
* [CSS Tricks: Text on Images](https://css-tricks.com/design-considerations-text-images/)
...
* ### Images
  ...
  * The floor fade. Technique where an image suddenly fades towards black at the bottom with white text writen over it.
