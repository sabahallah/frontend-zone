$(document).ready(function () {
  ...
  $(".js--section-features").waypoint(
    ...
    {
      offset:
        "60px;" /* this will happen 60px before we come to the section .js--section-feature we defined */,
    }
  );

  /* scroll when clicking the buttons */
  // $('.js--scroll-to-plans').click(function () {
  //     $("html, body").animate({ scrollTop: $('.js--section-plans').offset().top }, 500);/*js-section-feature*/
  // });

  // $('.js--scroll-to-start').click(function () {
  //     $("html, body").animate({ scrollTop: $('.js--section-features').offset().top }, 1500);/*js-section-feature*/
  // });

  /* animation on scroll */
  $(".jq-wp-animation-1").waypoint(
    function (direction) {
      if (direction == "down") {
    ...
    {
      offset:
        "50%;" /* this will happen 60px before we come to the section .js--section-feature we defined */,
    }
  );

  $(".jq-wp-animation-2").waypoint(
    function (direction) {
